...
+(NSDictionary*)encryptWithDESAndRSA:(NSData*) data withKey:(NSString*)key keyPath:(NSString*)keyPath{
    ...
    //rsa
    NSString* encryptedKey = [DESencrypt RSAEncryptData:key keyPath:keyPath];
    
    //des
    NSData* encryptedData = [DESencrypt DESEncrypt:data WithKey:key];
...
+(NSString*)RSAEncryptData:(NSString*)text keyPath:(NSString*)keyPath{
    NSData* data = [DESencrypt RSAEncryptToData:text keyPath:keyPath];
...
+(NSString*)DESEncryptWithBase64:(NSString*)str key:(NSString*)key{
    ...
    NSData* encryptData = [DESencrypt DESEncrypt:data WithKey:key];
...
+(NSString*)DESDecryptBase64:(NSString*)base64 key:(NSString*)key{
    ...
    NSData* data = [DESencrypt DESDecrypt:encryptData WithKey:key];
